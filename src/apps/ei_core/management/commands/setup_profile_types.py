...
from src.apps.ei_core.models import ProfileType, Component, RecordActionButton, TitleButton, AssociatedProfileType
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        genomics.components.set([assembly, files, seqannotation, read])
